...
public class ChoiceGPSRandomActivity extends AppCompatActivity {
    ...
    void choice_iv_clickListener() {
        ImageView ivBack = findViewById(R.id.choice_gps_r_back);
        ivBack.setOnClickListener(v -> finish());
    }

    void choice_et_clickListener() {
        //위치 설정 텍스트 클릭
        et_position.setOnClickListener(v -> {
    ...
    void choice_btn_clickListener() {
        //"추가" 버튼 클릭시,
        btn_add.setOnClickListener(v -> {   //"추가" 버튼을 클릭함으로써 위치를 추가하고 싶은 경우
        ...
        //"시간 기준" 버튼 클릭시,
        btn_search_time.setOnClickListener(v -> {
        ...
        //"거리 기준" 버튼 클릭시,
        btn_search_distance.setOnClickListener(v -> {
