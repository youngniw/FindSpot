...
public class CandidateTimePosition implements Comparable<CandidateTimePosition> {
    private int maxIndex = 0;        //(endX, endY)를 위치로 갖는 지점과의 소요시간이 가장 큰 위치의 인덱스 번호      TODO: 안씀
    private int minIndex = 0;        //(endX, endY)를 위치로 갖는 지점과의 소요시간이 가장 작은 위치의 인덱스 번호    TODO: 안씀
    ...
    public void calTimeGap() {
        ...
        Log.i("currentCTP_min", String.valueOf(minTime));
        Log.i("currentCTP_max", String.valueOf(maxTime));
    }
